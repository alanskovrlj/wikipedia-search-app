...
import {Files} from '../../global/types'

function Modal({files, setFilesModal} : {files: Files[], setFilesModal: (a:boolean) => void}) {
    ...
    return (<>
        <div onBlur={()=>setFilesModal(false)} id="defaultModal" tabIndex={-1} className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center flex" aria-modal="true" role="dialog">
            <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="p-6 h-42 flex  overflow-x-auto">
...
function FileList({files} : {files: Files[]}) {
    console.log(files)
    return (<>
